...
```powershell
.\.venv\Scripts\python.exe scripts\phase5_efficiency.py --all --max-docs-list 250 500 1000 --dims 64 1024 --output results\phase5\scaling_n
```

Vergleich nach Dimension:

```powershell
.\.venv\Scripts\python.exe scripts\phase5_efficiency.py --all --max-docs 1000 --dims 64 128 256 384 512 768 1024 --output results\phase5\scaling_dim
```
